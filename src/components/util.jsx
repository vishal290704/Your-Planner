...
export const styles = {
    ...
    inputDark: "bg-gray-600 text-white border-gray-700 focus:border-gray-500 focus:ring-gray-500",
    inputLight: "bg-white text-black border-gray-300 focus:border-blue-500 focus:ring-blue-500",
